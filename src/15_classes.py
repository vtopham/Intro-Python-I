...
# test = Geocache(1,2,"name","difficulty","size")
# print(f"Test name: {test.name}, test.difficulty: {test.difficulty}, test lon: {test.lon}")

# Make a new waypoint and print it out: "Catacombs", 41.70505, -121.51521

# YOUR CODE HERE
waypoint = Waypoint(41.70505, -121.51521, "Catacombs")
print(f"catacombs: name: {waypoint.name}, lat: {waypoint.lat}, lon: {waypoint.lon}")
